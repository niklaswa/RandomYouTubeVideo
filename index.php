...
if($publishedBeforeYear == explode('-', $DateOfFirstVideo)[0]) {
    $publishedBeforeMonth = str_pad(rand(explode('-', $DateOfFirstVideo)[1],12), 2, '0', STR_PAD_LEFT);
    $publishedBeforeDay = str_pad(rand(intval(explode('T', explode('-', $DateOfFirstVideo)[2])[0]),31), 2, '0', STR_PAD_LEFT);
} else {
